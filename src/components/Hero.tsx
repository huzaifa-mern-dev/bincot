...
export const Hero: React.FC = () => {
  ...
  return (
    <>
      <div className="relative min-h-screen flex flex-col items-center justify-center pt-16 bg-gradient-to-b from-primary-50 to-white">
        <div className="container mx-auto px-4 md:px-6 z-10">
          ...
          <div className="flex justify-center lg:mt-0 mb-8 mt-8">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary-600 text-white text-sm font-medium shadow-lg">
              ...
              <a href="#" className="ml-2 underline hover:text-primary-100 transition-colors">Enjoy the reading here</a>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 py-4">
            <div className="w-full lg:w-1/2 space-y-8">
              <div className="space-y-4 max-w-2xl">
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-accent-100 text-accent-700 text-sm">
                  <span className="flex h-2 w-2 rounded-full bg-accent-500 mr-2"></span>
                  <span>Strategic Business Consulting</span>
                </div>
                
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 leading-tight">
                  Transform Your Business with <span className="text-primary-600">Strategic Insights</span>
                </h1>
                <p className="text-lg md:text-xl text-neutral-600 leading-relaxed">
                  Unlock your business potential with data-driven strategies, operational excellence, and proven methodologies that drive sustainable growth.
                </p>
              </div>
            ...
            <div className="w-full lg:w-1/2 lg:pl-8">
              <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-primary-100 transform transition-transform hover:translate-y-[-5px]">
