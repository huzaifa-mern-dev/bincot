...
export const CTA: React.FC = () => {
  ...
  return (
    <>
      <section id="contact" className="py-24 bg-gradient-to-b from-white to-primary-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="font-semibold text-neutral-800 mb-1">Expert Analysis</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="font-semibold text-neutral-800 mb-1">Custom Roadmap</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="font-semibold text-neutral-800 mb-1">No Obligation</h4>
              ...
              <div className="relative bg-accent-900 p-8 md:p-12 lg:p-16 text-white flex flex-col justify-center">
                ...
                <div className="mt-8 p-6 bg-accent-800/50 backdrop-blur-sm rounded-lg border border-accent-700">
                  <p className="text-accent-100 italic">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      ...
                      <div className="flex self-end">
                        CEO at&nbsp;<a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="text-white font-medium underline hover:text-accent-200 transition-colors"
                        >
                          Fosway Group
                        </a>
                      </div>
